...
def run_test_practice_problem2a():
    ...
    #Test 1
    exp = [3, 4, 5, 6]
    act = practice_problem2a(seq1, delta1)
    print('Expected: ',exp)
    print('Actual:   ',act)

    #Test 2
    exp = [28, 39, 50, 61]
    act = practice_problem2a(seq2, delta2)
    print('Expected: ',exp)
    print('Actual:   ',act)

    #Test 3
    exp = [5, 6, 7, 8]
    act = practice_problem2a(seq1, delta2)
    print('Expected: ',exp)
    print('Actual:   ',act)

    #Test 4
    exp = [26, 37, 48, 59]
    act = practice_problem2a(seq2, delta1)
    print('Expected: ',exp)
    print('Actual:   ',act)
